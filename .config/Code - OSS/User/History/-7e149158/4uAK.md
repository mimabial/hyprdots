...
[Reis naar HyDe en verder](../../Hyprdots-to-DENv.md)
...
Start je systeem opnieuw op na het installatiescript klaar is en je voor de eerste keer naar het SDDM inlogscherm (of zwart scherm) brengt. Voor meer details, raadpleeg de [installatie wiki](https://github.com/DENv-Project/DENv/wiki/installation).
...
Om de DENv te updaten, moet je de laatste aanpassingen van Github ophalen en de configuraties herstellen door de volgende commando's uit te voeren:
...
Voor meer informatie, bezoek [DENv-Project/denv-themes](https://github.com/DENv-Project/denv-themes).
...
> Als je wilt dat jouw DENv-thema wordt getoond, of als je enkele niet-officiële thema's wilt vinden, bezoek [kRHYME7/denv-gallery](https://github.com/kRHYME7/denv-gallery)!
