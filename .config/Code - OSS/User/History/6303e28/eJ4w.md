...
<!-- # <a id=denv-raccourcis>DENv Raccourcis Clavier</a> -->

Voici tous les raccourcis clavier spécifiques à DENv.
...
Par exemple, pour créer un raccourci qui lance le **DENv Game Launcher**, ajoutez cette ligne :
