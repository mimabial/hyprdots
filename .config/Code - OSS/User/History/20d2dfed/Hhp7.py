...
REPO_URL = "https://github.com/DENv-Project/denv-gallery.git"
...
def fetch_data():
    global JSON_DATA
    json_file_path = os.path.join(CLONE_DIR, "denv-themes.json")
...
def get_theme_preview(theme):
    ...
    if theme == "[CONFIRM]":
        ...
        preview_text += (
            "👋 Let's DENvrate your system with more cool themes!\n\n"
            "  [TAB] to mark a theme\n"
