...
def main():
    ...
    config_file = os.path.join(xdg_state_home(), "denv", "config")
    colors_file = os.path.join(xdg_cache_home(), "denv/wall.dcol")
    ...
    # You can configure these in ~/.config/denv/config.toml
