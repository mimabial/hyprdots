# This Source Code Form is subject to the terms of the LibreWolf Public
...
## tool (the Fakespot by LibreWolf 'analyzer') other than 'checker', which is
## used in the name of the LibreWolf feature ('Review Checker'). If that is not
...
shopping-callout-not-opted-in-reminder-title = Siopa gyda denvr
