...
WALLBASH_SCRIPTS="${WALLBASH_SCRIPTS:-$denvConfDir/wallbash/scripts}"
hypr_border=10
...
# For user configuration edit '${confDir}/dunst/dunst.conf' then run 'denv-shell wallbash dunst' to apply changes.
# Updated dunst configuration: https://github.com/DENv-Project/DENv/blob/master/Configs/.config/dunst/dunst.conf

# DENv specific section // To override the default configuration edit '${cacheDir}/wallbash/dunst.conf'
# ------------------------------------------------------------------------------
[global]
...
# DENv Mandatory section // Non overridable // please open a request in https://github.com/DENv-Project/DENv
# ------------------------------------------------------------------------------
[global]

# to change font and size, set the following variables in ~/.config/denv/config.toml
# [notification]
