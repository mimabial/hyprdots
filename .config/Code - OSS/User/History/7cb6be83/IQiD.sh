...
# Auto-generated by DENv // Read-only
# // ----------------------------
# DENv Theme: ${DENV_THEME}
# Configuration File: "${DENV_THEME_DIR}/hypr.theme"
...
# exec = \${RUN_CMD}"
# source = \${SOURCE_FILE}
# exec = denv-shell walbash code \$CODE_THEME # Setting the code theme
