...
![denv_banner](Source/assets/denv_banner.png)
...
[Journey to DENv and beyond](./Hyprdots-to-DENv.md)
...
While installing DENv alongside another [DE](https://wiki.archlinux.org/title/Desktop_environment)/[WM](https://wiki.archlinux.org/title/Window_manager) should work, due to it being a heavily customized setup, it **will** conflict with your [GTK](https://wiki.archlinux.org/title/GTK)/[Qt](https://wiki.archlinux.org/title/Qt) theming, [Shell](https://wiki.archlinux.org/title/Command-line_shell), [SDDM](https://wiki.archlinux.org/title/SDDM), [GRUB](https://wiki.archlinux.org/title/GRUB), etc. and is at your own risk.

For NixOS support there is a separate project being maintained @ [Hydenix](https://github.com/richen604/denvnix/tree/main)
...
> [!TIP]
> You can also add any other apps you wish to install alongside DENv to `Scripts/pkg_user.lst` and pass the file as a parameter to install it like so:
>
> ```shell
...
For more details, please refer to the [installation wiki](https://github.com/DENv-Project/DENv/wiki/installation).
...
Whether you're helping with code, testing, or documentation, we appreciate your support in making DENv better for everyone. Thank you!
...
To update DENv, you will need to pull the latest changes from GitHub and restore the configs by running the following commands:
...
For more information, visit [DENv-Project/denv-themes](https://github.com/DENv-Project/denv-themes).
...
> If you wish to have your denv theme showcased, or you want to find some non-official themes, visit [kRHYME7/denv-gallery](https://github.com/kRHYME7/denv-gallery)!
